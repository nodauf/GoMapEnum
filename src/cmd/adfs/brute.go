...
Beware of account locking. No locking information is returned and therefore no failsafes could be set up.`,
	Example: `go run main.go adfs brute -d contoso.com -u users  -p pass
go run main.go adfs brute -t adfs.contoso.com -u users  -p pass -s 5 -o validUsers
go run main.go adfs brute -t adfs.contoso.com -u john.doe@contoso.com  -p Autumn2021! -s 5 -v`,
